...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_4x12(KC_ESC, KC_Y, KC_C, KC_L, KC_M, KC_K, KC_Z, KC_F, KC_U, KC_COMM, KC_QUOT, KC_BSPC, KC_TAB, LGUI_T(KC_I), LALT_T(KC_S), LCTL_T(KC_R), LSFT_T(KC_T), KC_G, KC_P, RSFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_A), RGUI_T(KC_O), KC_ENT, KC_GRV, KC_Q, KC_V, KC_W, KC_D, KC_J, KC_B, KC_H, KC_SLSH, KC_DOT, KC_X, KC_SCLN, KC_INS, KC_HOME, KC_END, KC_PGUP, KC_PGDN, LT(3,KC_CAPS), LT(2,KC_SPC), KC_DOWN, KC_UP, KC_LEFT, KC_RGHT, KC_DEL),
	...
	[2] = LAYOUT_ortho_4x12(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, LGUI_T(KC_1), LALT_T(KC_2), LCTL_T(KC_3), LSFT_T(KC_4), KC_5, KC_6, RSFT_T(KC_7), RCTL_T(KC_8), RALT_T(KC_9), RGUI_T(KC_0), KC_NO, KC_TRNS, KC_BSLS, KC_LBRC, KC_RBRC, KC_EQL, KC_NO, KC_NO, KC_MINS, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, MO(4), KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
