...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_4x12(KC_Q, KC_C, KC_H, KC_P, KC_V, KC_NO, KC_NO, KC_K, KC_Y, KC_O, KC_J, KC_SCLN, LGUI_T(KC_R), LALT_T(KC_S), LCTL_T(KC_N), LSFT_T(KC_T), KC_G, KC_NO, KC_NO, KC_W, RSFT_T(KC_U), RCTL_T(KC_E), RALT_T(KC_I), RGUI_T(KC_A), KC_X, KC_M, KC_L, KC_D, KC_B, KC_NO, KC_NO, KC_Z, KC_F, KC_QUOT, KC_COMM, KC_DOT, KC_NO, KC_NO, KC_ESC, LT(3,KC_CAPS), KC_TAB, KC_NO, KC_NO, KC_ENT, LT(2,KC_SPC), KC_BSPC, KC_NO, KC_NO),
	...
	[4] = LAYOUT_ortho_4x12(RESET, DF(0), DF(1), KC_PSCR, AU_TOG, KC_NO, KC_NO, RGB_TOG, RGB_HUD, RGB_HUI, RGB_VAD, RGB_VAI, LALT(KC_UP), LALT(KC_DOWN), SGUI(KC_LBRC), SGUI(KC_RBRC), MU_TOG, KC_NO, KC_NO, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_VOLU, LCTL(KC_PGUP), LCTL(KC_PGDN), C(S(KC_TAB)), LCTL(KC_TAB), MU_MOD, KC_NO, KC_NO, KC_NO, KC_MUTE, KC_NO, KC_BRID, KC_BRIU, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO)
};
